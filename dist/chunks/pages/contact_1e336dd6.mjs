/* empty css                           */import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, s as spreadAttributes, g as addAttribute, u as unescapeHTML, j as renderComponent, F as Fragment, h as renderSlot } from '../astro_618a73d7.mjs';
import 'clsx';
/* empty css                             */import { a as $$Container, $ as $$Layout } from './404_c7606d67.mjs';
...
const $$Astro$6 = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-icon/lib/Icon.astro", void 0);
...
const $$Astro$5 = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-icon/lib/Spritesheet.astro", void 0);
...
}, "/home/jet/website/node_modules/astro-icon/lib/SpriteProvider.astro", void 0);
...
}, "/home/jet/website/node_modules/astro-icon/lib/Sprite.astro", void 0);
...
}, "/home/jet/website/src/components/ui/button.astro", void 0);
...
}, "/home/jet/website/src/components/contactform.astro", void 0);

const $$Astro = createAstro("https://sahayai.github.io");
const $$Contact = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Contact;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Contact" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "Container", $$Container, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Sectionhead", $$Sectionhead, {}, { "desc": ($$result4) => renderTemplate`${renderComponent($$result4, "Fragment", Fragment, { "slot": "desc" }, { "default": ($$result5) => renderTemplate`We are here to tackle your inspection problems.` })}`, "title": ($$result4) => renderTemplate`${renderComponent($$result4, "Fragment", Fragment, { "slot": "title" }, { "default": ($$result5) => renderTemplate`Contact` })}` })} ${maybeRenderHead()}<div class="grid md:grid-cols-2 gap-10 mx-auto max-w-4xl mt-16"> <div> <h2 class="font-medium text-2xl text-gray-800">Contact Sahay AI</h2> <p class="text-lg leading-relaxed text-slate-500 mt-3">
Got a question for us? Want to check out our demo? 
          We are here to help. <br><br>Reach out on email or leave a voicemail on the cell below.
</p> <div class="mt-5"> <div class="flex items-center mt-2 space-x-2 text-gray-600"> ${renderComponent($$result3, "Icon", $$Icon, { "class": "text-gray-400 w-4 h-4", "name": "uil:map-marker" })} <span>Philadelphia, PA 19104</span> </div><div class="flex items-center mt-2 space-x-2 text-gray-600"> ${renderComponent($$result3, "Icon", $$Icon, { "class": "text-gray-400 w-4 h-4", "name": "uil:envelope" })}<a href="mailto:tejas@sahayai.com">tejas@sahayai.com</a> </div><div class="flex items-center mt-2 space-x-2 text-gray-600"> ${renderComponent($$result3, "Icon", $$Icon, { "class": "text-gray-400 w-4 h-4", "name": "uil:phone" })}<a href="tel:+1 (445) 208 9990">+1 (445) 208 9990</a> </div> </div> </div> <div> ${renderComponent($$result3, "Contactform", $$Contactform, {})} </div> </div> ` })} ` })}`;
}, "/home/jet/website/src/pages/contact.astro", void 0);

const $$file = "/home/jet/website/src/pages/contact.astro";
const $$url = "/contact";
