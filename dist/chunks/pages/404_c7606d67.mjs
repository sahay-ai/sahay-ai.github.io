...
import { e as createAstro, f as createComponent, r as renderTemplate, m as maybeRenderHead, g as addAttribute, h as renderSlot, s as spreadAttributes, A as AstroError, i as ImageMissingAlt, u as unescapeHTML, j as renderComponent, k as defineScriptVars, F as Fragment, l as renderHead } from '../astro_618a73d7.mjs';
import 'clsx';
import { i as isESMImportedImage, g as getImage$1 } from '../astro/assets-service_25ab4db6.mjs';

const $$Astro$p = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/src/components/container.astro", void 0);

const $$Astro$o = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/src/components/ui/link.astro", void 0);

const $$Astro$n = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro/components/Image.astro", void 0);

const $$Astro$m = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro/components/Picture.astro", void 0);

const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[]};
					new URL("file:///home/jet/website/dist/");
					const getImage = async (options) => await getImage$1(options, imageConfig);

const $$Astro$l = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-seo/src/components/OpenGraphArticleTags.astro", void 0);

const $$Astro$k = createAstro("https://sahayai.github.io");
const $$OpenGraphBasicTags = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$k, $$props, $$slots);
  Astro2.self = $$OpenGraphBasicTags;
  const { openGraph } = Astro2.props;
  return renderTemplate`<meta property="og:title"${addAttribute(openGraph.basic.title, "content")}><meta property="og:type"${addAttribute(openGraph.basic.type, "content")}><meta property="og:image"${addAttribute(openGraph.basic.image, "content")}><meta property="og:url"${addAttribute(openGraph.basic.url || Astro2.url.href, "content")}>`;
}, "/home/jet/website/node_modules/astro-seo/src/components/OpenGraphBasicTags.astro", void 0);

const $$Astro$j = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-seo/src/components/OpenGraphImageTags.astro", void 0);

const $$Astro$i = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-seo/src/components/OpenGraphOptionalTags.astro", void 0);

const $$Astro$h = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-seo/src/components/ExtendedTags.astro", void 0);

const $$Astro$g = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-seo/src/components/TwitterTags.astro", void 0);

const $$Astro$f = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-seo/src/components/LanguageAlternatesTags.astro", void 0);

const $$Astro$e = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-seo/src/SEO.astro", void 0);

const $$Astro$d = createAstro("https://sahayai.github.io");
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$d, $$props, $$slots);
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<footer class="my-20"> <p class="text-center text-sm text-slate-500">
Copyright © ${( new Date()).getFullYear()} Sahay AI. All rights reserved.
</p> <!--
...
Made by <a href="https://tagarwal.com" target="_blank" rel="noopener" class="hover:underline">
T
</a> </p> </footer>`;
}, "/home/jet/website/src/components/footer.astro", void 0);

const heroImage = new Proxy({"src":"/_astro/sahay_logo_edit.12858a22.png","width":128,"height":135,"format":"png"}, {
...
var _a$1;
const $$Astro$c = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-navbar/src/Astronav.astro", void 0);

const $$Astro$b = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-navbar/src/components/MenuIcon.astro", void 0);

const $$Astro$a = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-navbar/src/components/OpenIcon.astro", void 0);

const $$Astro$9 = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-navbar/src/components/CloseIcon.astro", void 0);

const $$Astro$8 = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-navbar/src/components/MenuItems.astro", void 0);

const $$Astro$7 = createAstro("https://sahayai.github.io");
...
}, "/home/jet/website/node_modules/astro-navbar/src/components/Dropdown.astro", void 0);
...
}, "/home/jet/website/node_modules/astro-navbar/src/components/DropdownSubmenu.astro", void 0);
...
}, "/home/jet/website/node_modules/astro-navbar/src/components/DropdownItems.astro", void 0);
...
}, "/home/jet/website/node_modules/astro-navbar/src/components/StickyHeader.astro", void 0);
...
}, "/home/jet/website/src/components/navbar/dropdown.astro", void 0);
...
const $$Navbar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Container", $$Container, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<header class="flex flex-col lg:flex-row justify-between items-center my-5"> ${renderComponent($$result2, "Picture", $$Picture, { "src": heroImage, "alt": "Astronaut in the air", "widths": [200, 400, 600], "sizes": "(max-width: 500px) 100vw, 620px", "loading": "eager", "format": "jpg " })} ${renderComponent($$result2, "Astronav", $$Astronav, {}, { "default": ($$result3) => renderTemplate` <div class="flex w-full items-center justify-between"> <a href="/" class="text-lg"><span class="font-bold text-slate-800">&nbsp;&nbsp;&nbsp;Sahay </span><span class="text-slate-500">AI</span> </a> <div class="block lg:hidden"> ${renderComponent($$result3, "MenuIcon", $$MenuIcon, { "class": "w-4 h-4 text-gray-800" })} </div> </div> ${renderComponent($$result3, "MenuItems", $$MenuItems, { "class": "hidden w-full  mt-2 lg:flex lg:mt-0" }, { "default": ($$result4) => renderTemplate` <ul class="flex flex-col lg:flex-row lg:gap-3"> ${menuitems.map((item, index) => renderTemplate`${renderComponent($$result4, "Fragment", Fragment, {}, { "default": ($$result5) => renderTemplate`${item.children && renderTemplate`${renderComponent($$result5, "Dropdown", $$Dropdown, { "title": item.title, "children": item.children, "lastItem": index === menuitems.length - 1 })}`}${!item.children && renderTemplate`<li> <a${addAttribute(item.path, "href")} class="flex lg:px-3 py-2 items-center text-gray-600 hover:text-gray-900"> <span> ${item.title}</span> ${item.badge && renderTemplate`<span class="ml-1 px-2 py-0.5 text-[10px] animate-pulse font-semibold uppercase text-white bg-indigo-600 rounded-full">
New
</span>`} </a> </li>`}` })}`)} </ul> <div class="lg:hidden flex items-center mt-3 gap-4"> ${renderComponent($$result4, "Link", $$Link, { "href": "#", "style": "muted", "block": true, "size": "md" })} ${renderComponent($$result4, "Link", $$Link, { "href": "#", "size": "md", "block": true }, { "default": ($$result5) => renderTemplate`Demo` })} </div> ` })} ` })} <div> <div class="hidden lg:flex items-center gap-4"> <a href="#"></a> ${renderComponent($$result2, "Link", $$Link, { "href": "https://app.sahayai.com/", "size": "md" }, { "default": ($$result3) => renderTemplate`Login` })} </div> </div> </header> ` })}`;
}, "/home/jet/website/src/components/navbar/navbar.astro", void 0);
...
const $$Layout = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const makeTitle = title ? title + " | Sahay" : "Sahay";
  return renderTemplate`<html lang="en"> <head><meta charset="UTF-8"><meta name="viewport" content="width=device-width"><link rel="icon" type="image/svg+xml" href="/company_logo.png"><meta name="generator"${addAttribute(Astro2.generator, "content")}><!-- <link rel="preload" as="image" href={src} alt="Hero" /> -->${renderComponent($$result, "SEO", $$SEO, { "title": makeTitle, "description": "Sahay", "canonical": canonicalURL, "twitter": {
    creator: "@surjithctly",
    site: "@web3templates",
...
}, "/home/jet/website/src/layouts/Layout.astro", void 0);
...
}, "/home/jet/website/src/pages/404.astro", void 0);

const $$file = "/home/jet/website/src/pages/404.astro";
const $$url = "/404";
...
export { $$Layout as $, _404 as _, $$Container as a, $$Picture as b, $$Link as c };
